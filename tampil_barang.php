        ...
        ?>
            <tr>
                ...
                <td width="150" align="center">
                    <a href="form_ubah_barang.php?id=<?php echo $data_barang['id_barang']; ?>"><button>EDIT</button></a> |
                    <a href="update_barang.php?id=<?php echo $data_barang['id_barang']; ?>&aksi=hapus"><button>HAPUS</button></a>
                </td>
            </tr>
        <?php
        } ?>
